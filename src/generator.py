...
class Questions:
    ...
    def load_model(self) -> None:
        ...
        self.model = AutoModelForCausalLM.from_pretrained(
            MODEL_NAME,
            # Laisse transformers choisir la precision numerique des poids
            torch_dtype="auto",
            # GPU si present, sinon CPU (necessite le paquet accelerate)
            device_map="auto",
        )

    # Assemble les chunks retournes par search() en un seul texte
    ...
    def generate_answer(self, question: str, context: str) -> str:
        ...
        # PreTrainedModel ne declare plus generate() : il vient d'un mixin
        # ajoute par chaque classe concrete. transformers fournit un Protocol
        # "modele + generate" pour ce cas, on l'affirme a mypy.
        model = cast(GenerativePreTrainedModel, self.model)
...
if __name__ == "__main__":
    ...
    print(f"\n{len(answered.search_results)} reponses en {elapsed:.1f}s\n")
